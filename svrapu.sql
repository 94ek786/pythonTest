/* CREATE SCHEMA `price_index` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci; */

CREATE TABLE `price_index`.`crawler_article` (
...
CREATE TABLE `price_index`.`crawler_articlemeta` (
...
CREATE TABLE `price_index`.`crawler_fields` (
...
CREATE TABLE `price_index`.`crawler_list` (
...
CREATE TABLE `price_index`.`crawler_media` (
  `id` bigint(50) NOT NULL AUTO_INCREMENT,
  `article_id` bigint(40) DEFAULT NULL,
...
CREATE TABLE `price_index`.`crawler_source` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `price_index`.`wp_postmeta` (
...
CREATE TABLE `price_index`.`wp_posts` (
...
CREATE TABLE `price_index`.`wp_term_relationships` (
...
CREATE TABLE `price_index`.`wp_term_taxonomy` (
...
CREATE TABLE `price_index`.`wp_termmeta` (
  `meta_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `term_id` bigint(20) unsigned NOT NULL DEFAULT '0',
  `meta_key` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `meta_value` longtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `price_index`.`wp_terms` (
...
INSERT INTO `price_index`.`crawler_source`
(`name`,
`description`,
`topics`,
`source_domain`,
...
INSERT INTO `price_index`.`crawler_fields`
(
`source_id`,
`source_fields`,
`target_fields`)
